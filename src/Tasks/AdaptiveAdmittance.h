 ...
 *
 * The AdaptiveAdmittance is by default a TransformTask, i.e. pure position
 ...
 *
 * This is a copied version of the admittance task implemented in mc_rtc, with some modifications to support adaptive
 * admittance coefficients
 *
 */
struct MC_TASKS_DLLAPI AdaptiveAdmittance : TransformTask
{
public:
   ...
   *
   */
  AdaptiveAdmittance(const mc_rbdyn::RobotFrame & frame, double stiffness = 5.0, double weight = 1000.0);
   ...
   *
   */
  AdaptiveAdmittance(const std::string & robotSurface,
