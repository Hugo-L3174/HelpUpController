 ...
 *
 */
struct MC_TASKS_DLLAPI FirstOrderAdmittance : AdmittanceTask
{
public:
   ...
   *
   */
  FirstOrderAdmittance(const mc_rbdyn::RobotFrame & frame, double stiffness = 5.0, double weight = 1000.0);
   ...
   *
   */
  FirstOrderAdmittance(const std::string & robotSurface,
